 ...
 * @since AM 5.5.0
 */
public class CreateIdentityPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(CreateIdentityPlugin.currentVersion,
				Collections.singletonList(CreateIdentity.class));
	}
	...
	public String getPluginVersion() {
		return CreateIdentityPlugin.currentVersion;
	}
}
